...
| M8.6 | Railway schedule for the same scan job | in progress | [railway inbox cron](./2026-09-06-008-feat-railway-inbox-cron-plan.md) — product contract [inbox worker](./2026-09-05-002-feat-inbox-worker-plan.md) R14 | Deploy scans while the laptop is closed; reruns skip processed ids | lfg |
