...
- `docs/plans/`: compound-engineering plan artifacts. Generated by `/ce-plan`, named `YYYY-MM-DD-<type>-<descriptive-name>-plan.md`. Protected artifacts — never flag for deletion.
